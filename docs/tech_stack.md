...
Once the SQL query runs, the result (a number or table) is sent to an **LLM** such as **GPT-4/5** or **LLaMA 3**.
...
## **7. Frontend: Streamlit or Lovable.dev**

We use **Streamlit or Lovable.dev** to build a simple web interface.
